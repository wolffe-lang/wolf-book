...
Ledger of every exercise in the corpus: 343 total. Hand-kept, and
...
`loop`/`break`-value drill beside §3.2's own example). **294 of the 343
are printed**, and
...
Tier totals: 193 run (lupin) · 9 run (lupin REPL) · 31 run (wolf) · 24 run (wolf + lupin) · 78 prose · 8 pending. That is 343.
...
comprehension 152 · extension 79 · spelunking 27 · design 37.
