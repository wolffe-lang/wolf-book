...
own catalog carries for it. The catalog holds 172 codes; these 56 are the
...
| `E1507` | the script's frontmatter is not a manifest a single file may carry | wolf | Appendix E |
