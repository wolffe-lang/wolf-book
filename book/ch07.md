...
<!-- AUDIT LEDGER (unpublished) — bs03, chapter 7. Filed to the
     ...
     - [ ] ba:blocker (semantics, spec clause exists and is unenforced)
           ...
           `mut` at both ends or a local `var`.
     - [ ] ba:blocker (checking) — `[mem.tier0.excl.2]` says
           ...
           explain text ahead of the checker.
     ...
     - [ ] ba:blocker (X1, differential) — lupin does not require the
           ...
           §7.4 shows wolf's diagnostic alone for this reason.
     ...
     - [ ] ba:papercut — the aliasing facts §7.7 describes are real and
           ...
           sidebar its evidence.
     - [ ] ba:papercut — `wolf --help` prints a scaffold banner naming a
           ...
           directly, which do work and are good.
