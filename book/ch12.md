...
Nothing in that paragraph is a trap or a panic, and the reason is worth
...
<!-- AUDIT LEDGER (unpublished) — bs06, chapter 12. Filed to the
     ...
     - [ ] ba:blocker (checking, soundness of the section's claim) —
     ...
     - [ ] ba:blocker (semantics, freeze) — reading through a frozen
